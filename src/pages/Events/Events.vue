            ...
            <div class="row">
              <div class="col-12 q-pa-xs">
                ...
                <q-select
                  ...
                  outlined
                  dense
                  :option-label="(items) => items.name+' '+items.surname+' E-posta: '+items.email+' Tel: '+items.phone"
                  option-value="id"
                  emit-value
                  map-options
                  input-debounce="0"
...
export default {
  ...
  mounted() {
    ...
    this.$store.dispatch('EventsModule/get')
    this.$store.dispatch('EventsModule/getEventCustomer')
